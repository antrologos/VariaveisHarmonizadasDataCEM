...
build_education_attainment_1991 <- function(CensusData){
        ...
        #setwd("c:\\users\\rogerio\\desktop\\Censo 1991\\")
        
        # Censo de 1991 ==============================================================================================================
        # ============================================================================================================================
        gc()
        # Abrindo dados
        #CensusData <- fread("Censo1991.csv")
        ...
        CensusData[v0328 == 3 & v0327 %in% c(4:5), education_tmp3 := 5]  # Assumindo que o ginasio finda na 4a serie. 5a serie é pouco usual (e talvez possa ser classe de admissao para o colegial)
        ...
        # Ajuste para idade
        #CensusData[v3072 <= 4,  education := NA]
