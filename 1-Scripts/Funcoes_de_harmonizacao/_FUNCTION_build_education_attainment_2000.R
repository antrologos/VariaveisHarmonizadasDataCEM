...
build_education_attainment_2000 <- function(CensusData){
        ...
        #setwd("c:\\users\\rogerio\\desktop\\Censo 2000\\")
        ...
        # de ensino (v0434 = 1). Alem disso, a idade dessas pessoas é compativel com a idade de 
        # conclusao do médio (não há casos de menores do que 17 anos). 
        # Ou seja: acredito mais na nossa classificação. O fato de terem sido marcados como 
        # 8 anos de estudo é estranho -- e não deve invalidar nossa categorizacao como Medio completo.
