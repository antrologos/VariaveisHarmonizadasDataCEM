build_education_attainment_2010 <- function(CensusData){
        ...
        #setwd("c:\\users\\rogerio\\desktop\\Censo 2010\\")
        
        # Censo de 2010 ==============================================================================================================
        # ============================================================================================================================
        
        # Abrindo dados
        #CensusData <- fread("CensusData.csv")
        ...
        # Observacoes:
        # 1 - Nossa variavel esta discrepante com a variavel "NÍvEL DE INSTRUÇÃO" (v6400) original
        # do Censo 2010. 43.574 registros estao classificados como "3- Médio completo e superior incompleto"
        ...
        # frequentado é o médio regular (v0629 = 7). Ou seja, estao todos ainda na escola
        # No entanto, a serie frequentada por todos eles é a quarta. Se entendermos que a duracao 
        # regulamentar é de apenas 3 anos, então essas pessoas devem ser marcadas como medio completo.
        ...
        # 2 - Outra discrepancia com respeito à v6400. 91.530 apontados nessa variavel como "5- Não determinado", estao 
        # marcados na nossa como medio incompleto
        # Todas essas pessoas frequentam escola (v0628 = 1 ou 2), o nivel é o medio regular (v0629 = 7) e a modalidade é
