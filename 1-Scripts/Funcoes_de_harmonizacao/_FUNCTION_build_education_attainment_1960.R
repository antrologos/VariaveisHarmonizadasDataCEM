...
build_education_attainment_1960 <- function(CensusData){
        ...
        # Abrindo dados
        # CensusData <- fread("Censo 1960/Censo.1960.brasil.pessoas.amostra.1.27porcento.csv")
        ...
        # Ajuste para idade (ISSO APENAS vAI SER FEITO NO SCRIPT PRINCIPAL, QUE CHAMA
        # E EXECUTA ESTE AQUI)
        # CensusData[idade <= 4,  education := NA]
        ...
        # a falta de vagas era mesmo uma das maiores questoes do periodo. Assumindo que esta amostra é de 1,27% e que todos
